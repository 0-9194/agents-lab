...
- [x] Implementada **Etapa A determinística** no runtime (`packages/pi-stack/extensions/guardrails-core.ts`):
...
- [x] Consolidado `read-guard` + `web-routing-guard` na extensão única (`guardrails-core`)
